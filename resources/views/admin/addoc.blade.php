            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{url('addingdoc')}}" method="POST">
                                    @csrf
                                    <div class="p-2">
                                        <label class="w-50">Doctor's Name</label>
                                        <select name="name" style="color: black;">
                                            <option style="color: black;">Select Name Below</option>
                                            @foreach ($doctors as $doctorsss)

                                            <option value="{{ $doctorsss->id }}" style="color: black;">{{$doctorsss->name}}</option>
                                    ...
                                    <div class="p-2">
                                        ...
                                        <input type="tel" style="color: black;" name="phone" placeholder="Enter Phone" required>
                                    </div>
                                    <div class="p-2">
                                        <label class="w-50">PF Number</label>
                                        <input type="text" style="color: black;" name="number" placeholder="Enter PF No" required>
                                    </div>
                                    <div class="p-2">
                                        <label class="w-50">Faculty</label>
                                        <select name="faculty" style="color: black;">
                                            <option style="color: black;">Choose Category Below</option>
